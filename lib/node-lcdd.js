...
class LCDClient extends EventEmitter {
    ...
    */
    ...
    wrapText(text) {
        ...
        if ((text.charAt(0) == '{' && text.charAt(text.length-1) == '}') || text.indexOf(' ') == -1) return text;
        else return '{'+text+'}';
    }
}
 ...
 */
LCDClient.prototype.addHBarWidget = function(screenID, widgetID, xpos, ypos, length, callback) {
    var self = this;
